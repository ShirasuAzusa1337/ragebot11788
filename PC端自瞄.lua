...
do
    ...
    local AimbotToggle = AimbotSection:AddToggle("Aimbot", { Title = "自瞄", Description = "切换自动瞄准器", Default = Configuration.Aimbot })
    ...
    if IsComputer then
        local OnePressAimingModeToggle = AimbotSection:AddToggle("OnePressAimingMode", { Title = "一键模式", Description = "使用一键模式而不是按住模式", Default = Configuration.OnePressAimingMode })
    ...
    local OffAimbotAfterKillToggle = AimbotSection:AddToggle("OffAimbotAfterKill", { Title = "击杀后关闭", Description = "击杀目标后禁用瞄准模式", Default = Configuration.OffAimbotAfterKill })
    ...
    local RandomAimPartToggle = AimbotSection:AddToggle("RandomAimPart", { Title = "随机瞄准部件", Description = "从下拉菜单中每隔一秒选择一个随机瞄准部件", Default = Configuration.RandomAimPart })
    ...
    AimbotSection:AddButton({
        ...
        Callback = function()
            ...
            AimPartDropdown:SetValues(Configuration.AimPartDropdownValues)
            Window:Dialog({
                Title = string.format(MonthlyLabels[os.date("*t").month], "打开自瞄"),
    ...
    local UseOffsetToggle = AimOffsetSection:AddToggle("UseOffset", { Title = "使用偏移量", Description = "切换偏移", Default = Configuration.UseOffset })
    ...
    local AutoOffsetToggle = AimOffsetSection:AddToggle("AutoOffset", { Title = "自动偏移", Description = "切换自动偏移", Default = Configuration.AutoOffset })
    ...
    local UseSensitivityToggle = SensitivityNoiseSection:AddToggle("UseSensitivity", { Title = "使用灵敏度", Description = "切换灵敏度", Default = Configuration.UseSensitivity })
    ...
    local UseNoiseToggle = SensitivityNoiseSection:AddToggle("UseNoise", { Title = "使用噪音", Description = "切换瞄准时的相机晃动", Default = Configuration.UseNoise })
    ...
    SpinBotSection:AddParagraph({
        Title = "注意",
        Content = "SpinBot 在 RenderStepped 渲染模式下无法正常工作。要解决此问题，请将渲染模式设置为非 RenderStepped 的其他值。"
    })

    local SpinBotToggle = SpinBotSection:AddToggle("SpinBot", { Title = "旋转机器人", Description = "切换旋转机器人", Default = Configuration.SpinBot })
    ...
    if IsComputer then
        local OnePressSpinningModeToggle = SpinBotSection:AddToggle("OnePressSpinningMode", { Title = "一键模式", Description = "使用一键模式而不是按住模式", Default = Configuration.OnePressSpinningMode })
    ...
    local RandomSpinPartToggle = SpinBotSection:AddToggle("RandomSpinPart", { Title = "随机旋转部件", Description = "每隔一秒从下拉菜单中选择一个随机旋转部件", Default = Configuration.RandomSpinPart })
    ...
    if getfenv().mouse1click and IsComputer then
        ...
        local TriggerBotToggle = TriggerBotSection:AddToggle("TriggerBot", { Title = "触发机器人", Description = "切换触发器机器人", Default = Configuration.TriggerBot })
        TriggerBotToggle:OnChanged(function(Value)
            Configuration.TriggerBot = Value
        end)

        local OnePressTriggeringModeToggle = TriggerBotSection:AddToggle("OnePressTriggeringMode", { Title = "一键模式", Description = "使用一键模式，而不是按住模式", Default = Configuration.OnePressTriggeringMode })
        OnePressTriggeringModeToggle:OnChanged(function(Value)
            Configuration.OnePressTriggeringMode = Value
        end)

        local SmartTriggerBotToggle = TriggerBotSection:AddToggle("SmartTriggerBot", { Title = "智能触发机器人", Description = "仅在瞄准时使用触发器机器人", Default = Configuration.SmartTriggerBot })
    ...
    local AliveCheckToggle = SimpleChecksSection:AddToggle("AliveCheck", { Title = "存活检查", Description = "切换存活检查", Default = Configuration.AliveCheck })
    AliveCheckToggle:OnChanged(function(Value)
        Configuration.AliveCheck = Value
    end)

    local GodCheckToggle = SimpleChecksSection:AddToggle("GodCheck", { Title = "上帝检查", Description = "切换 the 上帝检查", Default = Configuration.GodCheck })
    GodCheckToggle:OnChanged(function(Value)
        Configuration.GodCheck = Value
    end)

    local TeamCheckToggle = SimpleChecksSection:AddToggle("TeamCheck", { Title = "团队 检查", Description = "切换 the 团队 检查", Default = Configuration.TeamCheck })
    TeamCheckToggle:OnChanged(function(Value)
        Configuration.TeamCheck = Value
    end)

    local FriendCheckToggle = SimpleChecksSection:AddToggle("FriendCheck", { Title = "朋友 检查", Description = "切换 the 朋友 检查", Default = Configuration.FriendCheck })
    FriendCheckToggle:OnChanged(function(Value)
        Configuration.FriendCheck = Value
    end)

    local FollowCheckToggle = SimpleChecksSection:AddToggle("FollowCheck", { Title = "Follow 检查", Description = "切换 the Follow 检查", Default = Configuration.FollowCheck })
    FollowCheckToggle:OnChanged(function(Value)
        Configuration.FollowCheck = Value
    end)

    local VerifiedBadgeCheckToggle = SimpleChecksSection:AddToggle("VerifiedBadgeCheck", { Title = "Verified Badge 检查", Description = "切换 the Verified Badge 检查", Default = Configuration.VerifiedBadgeCheck })
    VerifiedBadgeCheckToggle:OnChanged(function(Value)
        Configuration.VerifiedBadgeCheck = Value
    end)

    local WallCheckToggle = SimpleChecksSection:AddToggle("WallCheck", { Title = "Wall 检查", Description = "切换 the Wall 检查", Default = Configuration.WallCheck })
    WallCheckToggle:OnChanged(function(Value)
        Configuration.WallCheck = Value
    end)

    local WaterCheckToggle = SimpleChecksSection:AddToggle("WaterCheck", { Title = "Water 检查", Description = "切换 the Water 检查 if Wall 检查 is enabled", Default = Configuration.WaterCheck })
    ...
    local FoVCheckToggle = AdvancedChecksSection:AddToggle("FoVCheck", { Title = "FoV 检查", Description = "切换 the FoV 检查", Default = Configuration.FoVCheck })
    ...
    local MagnitudeCheckToggle = AdvancedChecksSection:AddToggle("MagnitudeCheck", { Title = "Magnitude 检查", Description = "切换 the Magnitude 检查", Default = Configuration.MagnitudeCheck })
    ...
    local TransparencyCheckToggle = AdvancedChecksSection:AddToggle("TransparencyCheck", { Title = "Transparency 检查", Description = "切换 the Transparency 检查", Default = Configuration.TransparencyCheck })
    ...
    local WhitelistedGroupCheckToggle = AdvancedChecksSection:AddToggle("WhitelistedGroupCheck", { Title = "Whitelisted Group 检查", Description = "切换 the Whitelisted Group 检查", Default = Configuration.WhitelistedGroupCheck })
    ...
    local BlacklistedGroupCheckToggle = AdvancedChecksSection:AddToggle("BlacklistedGroupCheck", { Title = "Blacklisted Group 检查", Description = "切换 the Blacklisted Group 检查", Default = Configuration.BlacklistedGroupCheck })
    ...
    local IgnoredPlayersCheckToggle = ExpertChecksSection:AddToggle("IgnoredPlayersCheck", { Title = "Ignored Players 检查", Description = "切换 the Ignored Players 检查", Default = Configuration.IgnoredPlayersCheck })
    ...
    local TargetPlayersCheckToggle = ExpertChecksSection:AddToggle("TargetPlayersCheck", { Title = "Target Players 检查", Description = "切换 the Target Players 检查", Default = Configuration.TargetPlayersCheck })
    ...
    local PremiumCheckToggle = PremiumChecksSection:AddToggle("PremiumCheck", { Title = "Premium 检查", Description = "切换 the Premium 检查", Default = Configuration.PremiumCheck })
    ...
    if DEBUG or getfenv().Drawing and getfenv().Drawing.new then
        ...
        local ESPUseTeamColourToggle = ESPSection:AddToggle("ESPUseTeamColour", { Title = "Use 团队 Colour", Description = "Makes the ESP Colour match the Target Player 团队", Default = Configuration.ESPUseTeamColour })
    ...
    local NotificationsToggle = NotificationsWarningsSection:AddToggle("ShowNotifications", { Title = "Show Notifications", Description = "切换 the Notifications Show", Default = UISettings.ShowNotifications })
    ...
    local WarningsToggle = NotificationsWarningsSection:AddToggle("ShowWarnings", { Title = "Show Warnings", Description = "切换 the Security Warnings Show", Default = UISettings.ShowWarnings })
    ...
    if getfenv().isfile and getfenv().readfile and getfenv().writefile and getfenv().delfile then
        ...
        local AutoImportToggle = ConfigurationManager:AddToggle("AutoImport", { Title = "自动 导入", Description = "切换 the 自动 导入", Default = UISettings.AutoImport })
